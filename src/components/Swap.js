...
const Swap = () => {
  ...
  const swapHandler = async (e) => {
    ...
    const _inputToken = ethers.utils.parseUnits(inputAmount, 'ether')
            ...
            <Row className='my-3'>
              ...
              <InputGroup>
                <Form.Control 
                  ...
                  disabled={!inputToken} />
                <DropdownButton variant="outline-sencondary" title={inputToken ? inputToken : "select Token"}>
            ...
            <Row className='my-4'>
              ...
              <InputGroup>
                <Form.Control 
                  ...
                  disabled />
                <DropdownButton variant="outline-sencondary" title={outputToken ? outputToken : "select Token"}>
