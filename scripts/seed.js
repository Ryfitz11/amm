...
async function main() {
  ...
  transactoin = await dapp.connect(deployer).approve(amm.address, ammount)
  await transaction.wait()

  transactoin = await usd.connect(deployer).approve(amm.address, ammount)
  await transaction.wait()

  // Deployer adds liquidity
  console.log(`Adding liquidity...\n`)
  transaction = await amm.connect(deployer).addLiquidity(ammount, ammount)
  await transaction.wait()
